...
DEFAULT_LOCAL_MODEL_DIR = (
    Path(__file__).resolve().parents[3] / "models" / "ihc_segmentation"
)
DEFAULT_CONFIG_FILENAME = "config.yml"
DEFAULT_WEIGHTS_FILENAME = "best_model_binary_v1.pth"
DEFAULT_CONFIG_URL = (
    "https://huggingface.co/fedeceri/"
    "cochlea-hair-cell-binary-segmentation-unet2d/resolve/main/config.yml"
)
DEFAULT_WEIGHTS_URL = (
    "https://huggingface.co/fedeceri/"
    "cochlea-hair-cell-binary-segmentation-unet2d/resolve/main/"
